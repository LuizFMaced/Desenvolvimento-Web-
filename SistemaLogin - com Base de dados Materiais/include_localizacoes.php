<?php
	...
	if (isset($_POST["incluir_local"]))
	{
		$codigo = $_POST["codigo"];
		$dsc = $_POST["descricao"];
		$desc = strtoupper($dsc);
		
		$sql = "INSERT INTO localizacoes VALUES ";
		$sql .= "($codigo,'$desc')";
	...
	elseif (isset($_POST["atualizar_local"]))
	{
		$codigo = $_POST["codigo"];
		$dsc = $_POST["descricao"];
		$desc = strtoupper($dsc);
		...
		$sql.= "SET cod_localizacao=$codigo, ";
		$sql.= "dsc_localizacao='$desc' ";
		$sql.= "WHERE cod_localizacoes=$codigo ";
