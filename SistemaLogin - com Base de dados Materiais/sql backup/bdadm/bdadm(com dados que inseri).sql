...
--
-- Host: 127.0.0.1
-- Generation Time: 13-Ago-2017 às 19:14
...
INSERT INTO `usuarios` (`usuario`, `senha`, `nome`, `email`, `cidade`, `estado`) VALUES
('elisa', 'MTIzNDU2Nzg=', 'Elisa', 'elisa@yahoo.com', 'Brasilia', 'DF'),
('luiz', 'MTIzNDU2Nzg=', 'Luiz', 'luiz@gmail.com', 'Guarulhos', 'SP'),
('amanda', 'MTIzNDU2Nzg=', 'Amanda', 'manda@gmail.com', 'Belem', 'PA');
